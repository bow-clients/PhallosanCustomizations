 ...
 * @internal
 */
class Migration1746445767ProductCustomFields extends MigrationStep
{
    use MigrationTrait;
    ...
    final public const CUSTOM_FIELDS = [
        [
            ...
            'customFields' => [
                [
                    'name' => PhallosanConstants::CUSTOM_FIELD_DOCUMENTS_PRODUCT_NAME,
                    'type' => CustomFieldTypes::TEXT,
                    'config' => [
                        'customFieldType' => 'text',
                        'customFieldPosition' => 0,
                        'label' => [
                            'de-DE' => 'Produktname in Dokumenten',
                            'en-GB' => 'Product name in documents',
                        ],
