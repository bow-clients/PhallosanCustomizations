...
namespace PhallosanCustomizations\Decorator\Register;
...
class RegisterRouteDecorator extends RegisterRoute
{
    public function __construct(
        ...
        private readonly EntityRepository $countryRepositoryEntity,
    ) {
        parent::__construct(
            $eventDispatcher,
    ...
    {
        $country = $this->countryRepositoryEntity->search(new Criteria([$countryId]), $context->getContext())->get($countryId);
